export const TEXTS = {
  fermentation:
    'TÉCNICA DE FERMENTACIÓN LARGA: Seguimos un proceso de fermentación tradicional, utilizando habitaciones de temperatura controlada (una "cueva de kimchi") para lograr resultados óptimos de fermentación.',
